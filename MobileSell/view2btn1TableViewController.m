//
//  view2btn1TableViewController.m
//  MobileSell
//
...
@interface view2btn1TableViewController ()

@end

@implementation view2btn1TableViewController
@synthesize txt1;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"view2btn1" object:self userInfo:[NSDictionary dictionaryWithObject:txt1 forKey:@"txt1"]];
    //    [self setTxt:textt];
}
