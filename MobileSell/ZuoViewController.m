...
#import "Dai2ViewController.h"
#import "ZuoTableViewController.h"
...
- (void)viewDidLoad {
    ...
    //--
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(notificationAction1:) name:@"zuo" object:nil];
}
...
-(void)popover1:(id)sender
{
    ...
    ZuoTableViewController *controller = [[ZuoTableViewController alloc] initWithStyle:UITableViewStylePlain];
...
- (IBAction)timeBtnAc:(UIButton *)sender {
...
- (IBAction)SendAc:(UIButton *)sender {
    ...
    Dai2ViewController *daiQ2 = [[Dai2ViewController alloc]init];
    daiQ2.kkkey = _kkkey;
