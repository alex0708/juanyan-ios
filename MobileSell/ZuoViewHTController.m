...
#import "ZuoTableViewHTController.h"

@interface ZuoViewHTController ()

@end

@implementation ZuoViewHTController
...
-(void)popover1:(id)sender
{
    ...
    ZuoTableViewHTController *controller = [[ZuoTableViewHTController alloc] initWithStyle:UITableViewStylePlain];
