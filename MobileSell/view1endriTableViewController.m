//
//  view1endriTableViewController.m
//  MobileSell
//
...
@interface view1endriTableViewController ()

@end

@implementation view1endriTableViewController
@synthesize txt1;
- (void)viewDidLoad
{
    [super viewDidLoad];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"view1endri" object:self userInfo:[NSDictionary dictionaryWithObject:txt1 forKey:@"txt1"]];
    //    [self setTxt:textt];
}
