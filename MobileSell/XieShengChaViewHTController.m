...
#import "XieViewBtn1TableViewHTController.h"
#import "XieViewBtn2TableViewHTController.h"
...
@interface XieShengChaViewHTController ()

@end

@implementation XieShengChaViewHTController
...
-(void)popover1:(id)sender
{
    ...
    XieViewBtn1TableViewHTController *controller = [[XieViewBtn1TableViewHTController alloc] initWithStyle:UITableViewStylePlain];
...
-(void)popover2:(id)sender
{
    ...
    XieViewBtn2TableViewHTController *controller = [[XieViewBtn2TableViewHTController alloc] initWithStyle:UITableViewStylePlain];
