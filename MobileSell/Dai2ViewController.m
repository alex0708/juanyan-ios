...
#import "Dai22ViewController.h"

@interface Dai2ViewController ()

@end

@implementation Dai2ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        NSArray *xibViews = [[NSBundle mainBundle] loadNibNamed:@"Dai2CellView" owner:self options:NULL];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0)
    {
        Dai21ViewController *Dai21VC = [[Dai21ViewController alloc] init];
        
        Dai21VC.kkkey = _kkkey;
        [self.navigationController pushViewController:Dai21VC animated:YES];
    }else if(indexPath.row == 1){
        Dai22ViewController *Dai22VC = [[Dai22ViewController alloc] init];
