...
@interface Hz2ViewHTController ()

@end

@implementation Hz2ViewHTController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        NSArray *xibViews = [[NSBundle mainBundle] loadNibNamed:@"Hz2CellViewHT" owner:self options:NULL];
