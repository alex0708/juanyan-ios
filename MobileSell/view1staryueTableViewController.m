//
//  view1staryueTableViewController.m
//  MobileSell
//
...
@interface view1staryueTableViewController ()

@end

@implementation view1staryueTableViewController
@synthesize txt1;
- (void)viewDidLoad
{
    [super viewDidLoad];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"view1staryue" object:self userInfo:[NSDictionary dictionaryWithObject:txt1 forKey:@"txt1"]];
    //    [self setTxt:textt];
}
