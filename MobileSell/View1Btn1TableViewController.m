//
//  View1Btn1TableViewController.m
//  MobileSell
//
...
@interface View1Btn1TableViewController ()

@end

@implementation View1Btn1TableViewController
@synthesize txt1;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"view1btn1" object:self userInfo:[NSDictionary dictionaryWithObject:txt1 forKey:@"txt1"]];
    //    [self setTxt:textt];
}
