...
@interface view1endnianTableViewController ()

@end

@implementation view1endnianTableViewController
@synthesize txt1;
- (void)viewDidLoad
{
    [super viewDidLoad];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"view1endnian" object:self userInfo:[NSDictionary dictionaryWithObject:txt1 forKey:@"txt1"]];
    //    [self setTxt:textt];
}
