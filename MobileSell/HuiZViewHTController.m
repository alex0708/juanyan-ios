...
#import "Hz2ViewHTController.h"
#import "Hz3ViewHTController.h"
...
@interface HuiZViewHTController ()

@end

@implementation HuiZViewHTController
...
- (void)viewDidLoad {
    ...
    [btn1 setTitle:@"合同" forState:UIControlStateNormal];
...
- (IBAction)HsAc:(UIButton *)sender {
    ...
    if ([_viewkey isEqualToString:@"1"]) {
        ...
        Hz2ViewHTController *hz2VC = [[Hz2ViewHTController alloc]init];
        [self.navigationController pushViewController:hz2VC animated:YES];
        
    } else{
        Hz3ViewHTController *hz3VC = [[Hz3ViewHTController alloc]init];
