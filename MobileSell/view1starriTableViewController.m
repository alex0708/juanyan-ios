//
//  view1starriTableViewController.m
//  MobileSell
//
...
@interface view1starriTableViewController ()

@end

@implementation view1starriTableViewController
@synthesize txt1;
- (void)viewDidLoad
{
    [super viewDidLoad];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"view1starri" object:self userInfo:[NSDictionary dictionaryWithObject:txt1 forKey:@"txt1"]];
    //    [self setTxt:textt];
}
