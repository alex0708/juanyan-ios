...
@interface MingChaViewController ()

@end

@implementation MingChaViewController
...
-(void)popover1:(id)sender
{
    ...
    viewbtn1TableViewController *controller = [[viewbtn1TableViewController alloc] initWithStyle:UITableViewStylePlain];
