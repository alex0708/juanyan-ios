...
@interface Hz3ViewHTController ()

@end

@implementation Hz3ViewHTController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        NSArray *xibViews = [[NSBundle mainBundle] loadNibNamed:@"Hz3CellViewHT" owner:self options:NULL];
        cell = [xibViews lastObject];
        
    }
    
    UILabel *tv11lb = (UILabel *)[cell.contentView viewWithTag:80301];
