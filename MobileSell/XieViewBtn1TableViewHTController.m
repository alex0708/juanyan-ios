//
//  XieViewBtn1TableViewController.m
//  MobileSell
//
...
@interface XieViewBtn1TableViewHTController ()

@end

@implementation XieViewBtn1TableViewHTController
@synthesize txt1;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"xieviewbtn1" object:self userInfo:[NSDictionary dictionaryWithObject:txt1 forKey:@"txt1"]];
    //    [self setTxt:textt];
}
