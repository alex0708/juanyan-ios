...
#import "DaiQue1ViewController.h"
#import "DaiQ11ViewController.h"

@interface DaiQue1ViewController ()

@end

@implementation DaiQue1ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        NSArray *xibViews = [[NSBundle mainBundle] loadNibNamed:@"DaiQue1CellView" owner:self options:NULL];
