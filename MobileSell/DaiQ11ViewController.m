...
#import "DaiQ11ViewController.h"
#import "MingViewController.h"

#define KScreenHeight [UIScreen mainScreen].bounds.size.height
#define KScreenWidth [UIScreen mainScreen].bounds.size.width

@interface DaiQ11ViewController ()

@end

@implementation DaiQ11ViewController
...
{
    MingViewController *MingVC = [[MingViewController alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        NSArray *xibViews = [[NSBundle mainBundle] loadNibNamed:@"DaiQ11CellView" owner:self options:NULL];
